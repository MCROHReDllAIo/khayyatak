  ...
  return (
    <div id="home-experience" className="min-h-screen bg-[#050d18] text-white">
      ...
      <div className="relative mx-auto max-w-[1600px] px-3 md:px-5 lg:px-6 pb-6">
        {/* Brand strip — first viewport signal */}
        ...
        {/* Split experience — RTL: stores (right) | AI (left) */}
        <div className="mt-2 grid lg:grid-cols-[minmax(0,0.55fr)_minmax(0,0.45fr)] gap-3 md:gap-4 min-h-[calc(100vh-11rem)]">
          {/* RTL: first column = RIGHT = المتاجر (55%) */}
          <div
            className={cn(
          ...
          {/* RTL: second column = LEFT = الذكاء (45%) */}
          <div
            className={cn(
